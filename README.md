...
- [bun](https://github.com/oven-sh/bun) <sub>v1.2.4</sub>
...
- [oxc-minify](https://github.com/oxc-project/oxc.git) <sub>v0.53.0</sub>
- [@swc/core](https://github.com/swc-project/swc) <sub>v1.11.1</sub>
...
_Benchmarks last updated on <!-- lastUpdated:start -->Feb 27, 2025<!-- lastUpdated:end -->._
...
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                               |       <sup>-68% </sup>`22.86 kB` | **<sup>🏆-58% </sup>`8.17 kB`** |       <sup>*7x* </sup>`20 ms` |
| 2. [uglify-js](packages/minifiers/minifiers/uglify-js.ts)                                                                         | **<sup>🏆-69% </sup>`22.64 kB`** |       <sup>-58% </sup>`8.18 kB` |    <sup>*200x* </sup>`536 ms` |
| 3. [google-closure-compiler](packages/minifiers/minifiers/google-closure-compiler.ts)                                             |       <sup>-68% </sup>`22.83 kB` |       <sup>-58% </sup>`8.19 kB` | <sup>*1224x* </sup>`3,269 ms` |
| 4. [terser](packages/minifiers/minifiers/terser.ts)                                                                               |       <sup>-68% </sup>`23.07 kB` |       <sup>-57% </sup>`8.27 kB` |    <sup>*121x* </sup>`325 ms` |
...
| 11. [terser (no compress)](packages/minifiers/minifiers/terser.ts)                                                                |       <sup>-65% </sup>`25.08 kB` |       <sup>-55% </sup>`8.75 kB` |     <sup>*53x* </sup>`142 ms` |
...
| 3. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                   |       <sup>-66% </sup>`58.27 kB` |       <sup>-48% </sup>`18.70 kB` |      <sup>*8x* </sup>`48 ms` |
...
xychart-beta
	...
	bar [84498,30883,30903,30912,30970,31468,31470,31621,31799,31954,32653,33086,40879]
```
...
| **Minifier**                                                                                                            |                **Minified size** |               **Minzipped size** |                     **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                     |       <sup>-69% </sup>`89.18 kB` | **<sup>🏆-63% </sup>`30.88 kB`** |      <sup>*9x* </sup>`80 ms` |
...
xychart-beta
	...
	bar [89668,42710,42919,43036,43370,43925,44230,44368,44376,44450,44679,45400,57169]
```
...
| **Minifier**                                                                                                   |                 **Minified size** |               **Minzipped size** |                     **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                            |       <sup>-66% </sup>`115.75 kB` | **<sup>🏆-52% </sup>`42.71 kB`** |     <sup>*8x* </sup>`110 ms` |
...
| 4. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                      |       <sup>-87% </sup>`69.89 kB` |       <sup>-74% </sup>`25.21 kB` |      <sup>*6x* </sup>`86 ms` |
...
xychart-beta
	...
	bar [130686,87016,87224,88087,88162,88319,89156,89891,90800,92395,94121]
```
...
| 2. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                        |       <sup>-52% </sup>`265.32 kB` |       <sup>-33% </sup>`87.22 kB` |     <sup>*7x* </sup>`234 ms` |
...
xychart-beta
	...
	bar [193763,122364,123114,123334,123482,124428,124609,124897,126562,126707,127653,145178]
```
...
| 2. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                            |       <sup>-55% </sup>`455.67 kB` |       <sup>-36% </sup>`123.11 kB` |     <sup>*6x* </sup>`200 ms` |
...
xychart-beta
	...
	bar [248267,158751,159071,159198,160835,162998,163036,163198,163725,164737,166210,193471]
```
...
| **Minifier**                                                                                                               |                 **Minified size** |                **Minzipped size** |                          **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                        |       <sup>-48% </sup>`643.13 kB` | **<sup>🏆-36% </sup>`158.75 kB`** |          <sup>*6x* </sup>`313 ms` |
...
| 4. [oxc-minify](packages/minifiers/minifiers/oxc-minify.ts)                                                                |       <sup>-48% </sup>`647.03 kB` |       <sup>-35% </sup>`160.84 kB` |           <sup>*1x* </sup>`61 ms` |
...
xychart-beta
	...
	bar [309942,157435,157897,158706,162262,165131,166386,167579,181071,182671]
```
...
| 2. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                                   |       <sup>-67% </sup>`707.60 kB` |       <sup>-49% </sup>`157.90 kB` |          <sup>*8x* </sup>`457 ms` |
| 3. [terser](packages/minifiers/minifiers/terser.ts)                                                                                   |       <sup>-66% </sup>`715.58 kB` |       <sup>-49% </sup>`158.71 kB` |       <sup>*80x* </sup>`4,552 ms` |
| 4. [oxc-minify](packages/minifiers/minifiers/oxc-minify.ts)                                                                           |       <sup>-66% </sup>`716.14 kB` |       <sup>-48% </sup>`162.26 kB` |           <sup>*1x* </sup>`83 ms` |
...
| 9. [bun](packages/minifiers/minifiers/bun.ts)                                                                                         |       <sup>-66% </sup>`727.90 kB` |       <sup>-41% </sup>`182.67 kB` |           <sup>*1x* </sup>`85 ms` |
...
xychart-beta
	...
	bar [684611,321244,321987,324635,330736,331412,331563,331791,337934]
```
...
| **Minifier**                                                                                                                          |                 **Minified size** |                **Minzipped size** |                          **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                                   | **<sup>🏆-69% </sup>`994.51 kB`** | **<sup>🏆-53% </sup>`321.24 kB`** |          <sup>*6x* </sup>`835 ms` |
...
| 8. [bun](packages/minifiers/minifiers/bun.ts)                                                                                         |         <sup>-68% </sup>`1.02 MB` |       <sup>-51% </sup>`337.93 kB` |          <sup>*1x* </sup>`140 ms` |
...
xychart-beta
	...
	bar [825175,452819,457786,463352,472044,475480,478572,488279,491833]
```
...
| **Minifier**                                                                                                                          |               **Minified size** |                **Minzipped size** |                          **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                                   | **<sup>🏆-68% </sup>`2.15 MB`** | **<sup>🏆-45% </sup>`452.82 kB`** |        <sup>*8x* </sup>`1,172 ms` |
| 2. [terser](packages/minifiers/minifiers/terser.ts)                                                                                   |       <sup>-66% </sup>`2.25 MB` |       <sup>-45% </sup>`457.79 kB` |       <sup>*56x* </sup>`8,104 ms` |
| 3. [oxc-minify](packages/minifiers/minifiers/oxc-minify.ts)                                                                           |       <sup>-66% </sup>`2.28 MB` |       <sup>-44% </sup>`463.35 kB` |          <sup>*1x* </sup>`230 ms` |
...
| 8. [bun](packages/minifiers/minifiers/bun.ts)                                                                                         |       <sup>-66% </sup>`2.30 MB` |       <sup>-40% </sup>`491.83 kB` |          <sup>*1x* </sup>`189 ms` |
| 9. [babel-minify](packages/minifiers/minifiers/babel-minify.ts) <sub title="Failed: timeout">❌ Timed out</sub>                        |                               - |                                 - | <sup>:warning:</sup> `+10,000 ms` |
| 10. [google-closure-compiler](packages/minifiers/minifiers/google-closure-compiler.ts) <sub title="Failed: timeout">❌ Timed out</sub> |                               - |                                 - | <sup>:warning:</sup> `+10,000 ms` |
...
xychart-beta
	...
	bar [1884998,859369,860723,876535,876658,879301,915551]
```
...
| **Minifier**                                                                                                                           |               **Minified size** |                **Minzipped size** |                          **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                                    | **<sup>🏆-70% </sup>`3.33 MB`** | **<sup>🏆-54% </sup>`859.37 kB`** |        <sup>*8x* </sup>`2,248 ms` |
| 2. [oxc-minify](packages/minifiers/minifiers/oxc-minify.ts)                                                                            |       <sup>-69% </sup>`3.35 MB` |       <sup>-54% </sup>`860.72 kB` |          <sup>*1x* </sup>`453 ms` |

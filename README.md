...
xychart-beta
	...
	bar [84498,30870,30879,30912,31470,31474,31621,31799,31954,32630,33086,40879]
```
...
| 2. [uglify-js](packages/minifiers/minifiers/uglify-js.ts)                                                                      |       <sup>-55% </sup>`451.54 kB` |       <sup>-36% </sup>`123.28 kB` | <sup>*110x* </sup>`3,637 ms` |
...
| 6. [@tdewolff/minify](packages/minifiers/minifiers/tdewolff-minify.ts)                                                         |       <sup>-55% </sup>`456.69 kB` |       <sup>-36% </sup>`124.90 kB` |    **<sup>🏆 </sup>`33 ms`** |
...
| **Minifier**                                                                                                                         |                 **Minified size** |                **Minzipped size** |                          **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                                  |       <sup>-67% </sup>`707.22 kB` | **<sup>🏆-49% </sup>`157.86 kB`** |          <sup>*9x* </sup>`535 ms` |
...
| **Minifier**                                                                                                                         |               **Minified size** |                **Minzipped size** |                          **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                                  | **<sup>🏆-68% </sup>`2.15 MB`** | **<sup>🏆-45% </sup>`452.88 kB`** |        <sup>*9x* </sup>`1,298 ms` |

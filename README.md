...
_Benchmarks last updated on <!-- lastUpdated:start -->Oct 8, 2024<!-- lastUpdated:end -->._
...
| **Minifier**                                                                                                                         |                 **Minified size** |                **Minzipped size** |                          **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                                  | **<sup>🏆-69% </sup>`993.25 kB`** | **<sup>🏆-53% </sup>`320.27 kB`** |       <sup>*10x* </sup>`1,084 ms` |

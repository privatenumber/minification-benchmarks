...
xychart-beta
	...
	bar [84498,30866,30903,30913,30969,31446,31470,31621,31799,31954,32653,33086,40879]
```
...
xychart-beta
	...
	bar [193763,122353,123291,123334,123490,124428,124609,124885,126562,126707,127653,145178]
```
...
xychart-beta
	...
	bar [248267,158764,159071,159200,160827,162998,163036,163198,163725,164610,166210,193471]
```
...
<!-- analysis:start -->
Let's light up this JavaScript minification showdown! Twelve rounds of intense competition pushed each minifier to its limits, and boy, were there surprises. Who compressed fastest, who shrank code the most, and who came out swinging? Stay strapped in; here’s what went down.

### Best minifier
**@swc/core** steals the crown! With phenomenal speed across large and small files, and consistently ranking at or near the top for gzip size, this beast balances everything you could ask for: top-tier compression and snappy performance. Whether tackling a lean package like "react" or a colossal chunk like "typescript," it comfortably mingles with the best in size while beating most rivals on speed. 

### Honorable mentions
- **oxc-minify**: The speed king! If you’re chasing blistering performance, this newcomer breezes through massive files like "antd" and "three," though usually sacrifices a tiny bit of compression depth to keep its tempo. A superb choice for size-savvy developers in a rush. 
- **uglify-js**: The elder statesman isn’t retiring just yet! It often pulls off the smallest gzip sizes, notably dominating "lodash," "victory," and "d3." But the processing speed? Yikes, grab some coffee unless the file’s tiny. 
- **terser**: Solid compression and reasonable speed (compared to uglify-js)—though better when skipping compression altogether! If you’re okay trading some CPU cycles for quality results, terser remains a heavyweight contender. 

### Eliminated
- **babel-minify**: Poor thing didn’t make it past "d3." With an unforgiving runtime error, it’s best to leave this one under wraps for now. 
- **tedivm/jshrink**: Regex hiccups in "d3" brought this minifier to its knees, leaving the door wide open for competitors. A shame, really, as regex shouldn’t end the show. 
- **bun**: A speed demon undone by post-validation errors on larger packages. It’s speedy but stumbled on precision and correctness. Hold off until patch updates make it less volatile. 

### Quick outro
What a whirlwind race! These minifiers showcased raw compression power and clever engineering. Congratulations to @swc/core for taking home the gold, but all contenders impressed in their own way. Regular developers now have a clear edge armed with these battle-tested stats. Tight on size? Root for uglify-js. Tight on time? Call up oxc-minify. Experimentation’s the key; we’ll be cheering for slick results ahead!
<!-- analysis:end -->

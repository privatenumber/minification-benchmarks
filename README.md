...
- [bun](https://github.com/oven-sh/bun) <sub>v1.1.6</sub>
...
_Benchmarks last updated on <!-- lastUpdated:start -->Apr 29, 2024<!-- lastUpdated:end -->._
...
| 10. [bun](packages/minifiers/minifiers/bun.ts)                                                                           |       <sup>-86% </sup>`74.12 kB` |       <sup>-73% </sup>`26.47 kB` |      <sup>*3x* </sup>`25 ms` |

...
_Benchmarks last updated on <!-- lastUpdated:start -->Jun 11, 2024<!-- lastUpdated:end -->._
...
| 8. [bun](packages/minifiers/minifiers/bun.ts)                                                                                     |       <sup>-67% </sup>`24.01 kB` |       <sup>-55% </sup>`8.65 kB` |       <sup>*6x* </sup>`14 ms` |
...
xychart-beta
	...
	bar [130686,87040,87283,88319,88343,89156,89891,90800,92395,94121]
```
...
xychart-beta
	...
	bar [309942,157861,158090,158718,165131,166386,167579,181071,182659]
```
...
| **Minifier**                                                                                                                         |                 **Minified size** |                **Minzipped size** |                          **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                                  | **<sup>🏆-69% </sup>`993.11 kB`** | **<sup>🏆-53% </sup>`320.24 kB`** |        <sup>*9x* </sup>`1,038 ms` |
...
xychart-beta
	...
	bar [825175,452876,457817,472052,475480,478572,488279,491753]
```

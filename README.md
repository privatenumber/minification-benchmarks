...
_Benchmarks last updated on <!-- lastUpdated:start -->Jul 14, 2025<!-- lastUpdated:end -->._
...
| **Minifier**                                                                                                                           |               **Minified size** |                **Minzipped size** |                          **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                                    | **<sup>🏆-70% </sup>`3.31 MB`** | **<sup>🏆-54% </sup>`859.08 kB`** |        <sup>*6x* </sup>`1,678 ms` |
...
<!-- analysis:start -->
The minification race is over, and what a battle it was! From lightning-fast processing to razor-thin sizes, the competition was fierce. Let's dive into the results and crown our champions.

### Best minifier
@swc/core comes out on top! This phenomenal minifier combines impressive compression with blazing speed. Across most rounds, it consistently stayed competitive or led in size reduction while dominating the speed charts in larger files like "three," "antd," and "typescript." If you're looking for an all-rounder with compression prowess and sub-second performance, @swc/core is an unbeatable champion.

### Honorable mentions
Moving to the podium, **oxc-minify** roared with improbable sub-50ms speeds! While it fell slightly behind @swc/core in size compression, its blend of speed and performance made it a top contender. For users who prioritize balanced efficiency, it's a solid choice.

@tdewolff/minify struck again and again with lightning-fast execution times. Though it doesn't compress quite as well as the leaders, it's often within 3-5% of the top competitors while executing in mere milliseconds. In use cases where speed is paramount, like continuous CI/CD pipelines, this is the clear favorite.

**Uglify-js** earns recognition for impeccable compression rates! It topped the charts for the smallest gzip sizes in many rounds, like "react," "moment," and "lodash." However, its runtime is substantially slower, often lagging several seconds behind the fastest options. If your absolute goal is to squeeze every byte out of your bundles, uglify-js is your tool.

**Terser** deserves an applause as a consistent all-rounder. Positioned between uglify-js and @swc/core in terms of size and speed, it balances byte reduction with reasonable performance. For those transitioning from uglify-js but seeking a more mid-tier runtime, terser is a reliable bet.

### Eliminated
Sadly, some contestants didn't make the cut.

- **babel-minify** stumbled and failed early in the competition due to a critical "property of undefined" error during "d3" minification. It’s unsuitable unless you enjoy debugging incompatible libraries.
  
- **tedivm/jshrink** suffered an unfortunate regex mishap, leaving it stranded during "d3." With issues parsing larger files accurately, it's too unreliable to recommend.

- **bun** faltered during "typescript" post-validation. Strange line-ending mismatches made it fail correctness tests, ruling it out for now.

The field of minifiers is more exciting and dynamic than ever! Congratulations to @swc/core for earning the crown while @tdewolff/minify and oxc-minify dazzled with incredible speed. A respectful nod to uglify-js and terser for their compression mastery. Whatever your needs, there’s a minifier athlete for you in this race.
<!-- analysis:end -->

...
_Benchmarks last updated on <!-- lastUpdated:start -->Jul 7, 2025<!-- lastUpdated:end -->._
...
<!-- analysis:start -->
Welcome to the Minification Grand Prix! Where JavaScript minifiers battle for supremacy in size and speed. We’ve got blazing speed records, jaw-dropping compression ratios, and even a few wipeouts. Buckle up as we crown the ultimate minifier and reveal who ruled the track.

### Best Minifier
**@swc/core** takes the gold medal by balancing phenomenal compression ratios and raw speed, winning a striking **9 rounds outright.** Whether it's crunching "react," flying through "antd," or taming the beast that is "typescript," @swc/core consistently delivers some of the smallest gzip sizes while processing massive files in mere milliseconds. Its best compression cuts were tied with heavyweight competitors like `uglify-js` and `terser`—but it outpaced them by *miles* in raw performance. A true champion for both developers in a hurry and websites chasing bandwidth savings.

### Honorable Mentions
- **oxc-minify** proved itself as the sprinter of the pack, taking the fastest minifier title four times, especially with medium and large packages like "lodash" and "terser." It might not always achieve the absolute smallest size, but for users needing *speed* without sacrificing too much compression, oxc-minify is a worthy rival.
  
- **uglify-js** boasts legendary compression, reigning as size champion in challenging rounds like "lodash," "d3," and "victory." However, it struggles as the heavyweight bruiser; processing speed can stretch to *minutes*, and its inability to complete some larger tasks left it slightly tarnished.

- **terser** is the all-rounder. While not the fastest or the absolute best in size, it’s robust, dependable, and delivers solid results across the board. If you’re familiar with terser from years past, you won’t be disappointed.

### Eliminated
Every competition has its droppers, and unfortunately, some gloves didn’t meet the ring. Diplomatically:
- **babel-minify**, an old-timer showing its age, stumbled outright on "d3," its error messages leaving little doubt it’s time to retire this racer.
- **tedivm/jshrink**, while nifty for simplistic tasks, collapsed spectacularly on regex-heavy files like "d3."
- **bun,** touted for runtime speed, couldn’t hold its ground with "typescript," fumbling post-validation compatibility checks and waving the white flag.

### Final Thoughts
What a spectacular tournament! With fierce competition and impressive performances, @swc/core emerges as the go-to minifier for the average user chasing the best of both worlds—near-perfect gzip sizes and blinding speed.

But all competitors showed their strengths. Whether you need the record-breaking compression of `uglify-js` or the zippy refinement of `oxc-minify`, JavaScript enthusiasts now have a well-equipped toolkit to choose from. A round of applause for our contenders!
<!-- analysis:end -->

...
| ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ | -------------- |
| [oxc-minify](https://github.com/oxc-project/oxc.git)                                                        | [0.77.1](https://www.npmjs.com/package/oxc-minify/v/0.77.1)                          | 2025-07-16     |
| [@swc/core](https://github.com/swc-project/swc)                                                             | [1.12.14](https://www.npmjs.com/package/@swc/core/v/1.12.14)                         | 2025-07-14     |
| [google-closure-compiler](https://github.com/git+https://github.com/google/closure-compiler-npm.git#master) | [20250709.0.0](https://www.npmjs.com/package/google-closure-compiler/v/20250709.0.0) | 2025-07-11     |
...
_Benchmarks last updated on <!-- lastUpdated:start -->Jul 16, 2025<!-- lastUpdated:end -->._
...
xychart-beta
	...
	bar [19385,8177,8186,8216,8255,8448,8481,8543,8628,8661,8668,8739,11040]
```
...
| 3. [google-closure-compiler](packages/minifiers/minifiers/google-closure-compiler.ts)                                             |       <sup>-68% </sup>`22.84 kB` |       <sup>-58% </sup>`8.22 kB` | <sup>*1290x* </sup>`3,388 ms` |
...
| 6. [oxc-minify](packages/minifiers/minifiers/oxc-minify.ts)                                                                       |       <sup>-67% </sup>`23.48 kB` |       <sup>-56% </sup>`8.48 kB` |        <sup>*1x* </sup>`3 ms` |
...
xychart-beta
	...
	bar [36231,18568,18689,18747,18923,19119,19259,19334,19478,19569,19651,19857,24998]
```
...
| 3. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                   |       <sup>-66% </sup>`58.42 kB` |       <sup>-48% </sup>`18.75 kB` |      <sup>*5x* </sup>`31 ms` |
| 4. [google-closure-compiler](packages/minifiers/minifiers/google-closure-compiler.ts)                                 |       <sup>-66% </sup>`58.29 kB` |       <sup>-48% </sup>`18.92 kB` | <sup>*638x* </sup>`3,555 ms` |
...
xychart-beta
	...
	bar [84498,30856,30866,30903,30971,31446,31470,31555,31799,31954,32653,33092,40879]
```
...
| 11. [google-closure-compiler](packages/minifiers/minifiers/google-closure-compiler.ts)                                  |       <sup>-68% </sup>`92.73 kB` |       <sup>-61% </sup>`33.09 kB` | <sup>*493x* </sup>`3,886 ms` |
...
xychart-beta
	...
	bar [89668,42730,42870,43036,43339,43925,44184,44358,44368,44450,44636,45400,57169]
```
...
| **Minifier**                                                                                                   |                 **Minified size** |               **Minzipped size** |                     **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                            |       <sup>-66% </sup>`115.69 kB` | **<sup>🏆-52% </sup>`42.73 kB`** |      <sup>*5x* </sup>`68 ms` |
...
| 4. [oxc-minify](packages/minifiers/minifiers/oxc-minify.ts)                                                    |       <sup>-66% </sup>`117.22 kB` |       <sup>-52% </sup>`43.34 kB` |      <sup>*1x* </sup>`19 ms` |
...
| 6. [google-closure-compiler](packages/minifiers/minifiers/google-closure-compiler.ts)                          |       <sup>-66% </sup>`115.61 kB` |       <sup>-51% </sup>`44.18 kB` | <sup>*335x* </sup>`4,384 ms` |
...
| 2. [google-closure-compiler](packages/minifiers/minifiers/google-closure-compiler.ts)                                    |       <sup>-86% </sup>`73.50 kB` |       <sup>-74% </sup>`25.02 kB` | <sup>*353x* </sup>`4,175 ms` |
...
xychart-beta
	...
	bar [130686,87016,87205,87997,88135,88319,89069,89882,90800,92395,94166]
```
...
| 4. [oxc-minify](packages/minifiers/minifiers/oxc-minify.ts)                                                                |       <sup>-51% </sup>`270.80 kB` |       <sup>-33% </sup>`88.14 kB` |      <sup>*1x* </sup>`44 ms` |
...
| 10. [google-closure-compiler](packages/minifiers/minifiers/google-closure-compiler.ts)                                     |       <sup>-51% </sup>`270.32 kB` |       <sup>-28% </sup>`94.17 kB` | <sup>*205x* </sup>`6,660 ms` |
...
| **Minifier**                                                                                                                   |                 **Minified size** |                **Minzipped size** |                     **Time** |
| 1. [oxc-minify](packages/minifiers/minifiers/oxc-minify.ts)                                                                    |       <sup>-56% </sup>`440.17 kB` | **<sup>🏆-37% </sup>`122.35 kB`** |      <sup>*1x* </sup>`45 ms` |
...
| 8. [google-closure-compiler](packages/minifiers/minifiers/google-closure-compiler.ts)                                          | **<sup>🏆-56% </sup>`439.97 kB`** |       <sup>-35% </sup>`126.45 kB` | <sup>*172x* </sup>`5,985 ms` |
...
xychart-beta
	...
	bar [248267,158751,159071,159165,160826,162771,163036,163181,163725,164610,166210,193471]
```
...
| **Minifier**                                                                                                               |                 **Minified size** |                **Minzipped size** |                          **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                        |       <sup>-48% </sup>`643.03 kB` | **<sup>🏆-36% </sup>`158.75 kB`** |          <sup>*4x* </sup>`206 ms` |
...
| 5. [google-closure-compiler](packages/minifiers/minifiers/google-closure-compiler.ts)                                      |       <sup>-48% </sup>`644.52 kB` |       <sup>-34% </sup>`162.77 kB` |      <sup>*154x* </sup>`7,672 ms` |
...
xychart-beta
	...
	bar [309942,157435,157765,158459,162241,165014,166176,167579,181071,182671]
```
...
| 2. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                                   |       <sup>-67% </sup>`706.01 kB` |       <sup>-49% </sup>`157.77 kB` |          <sup>*5x* </sup>`306 ms` |
| 3. [terser](packages/minifiers/minifiers/terser.ts)                                                                                   |       <sup>-67% </sup>`712.87 kB` |       <sup>-49% </sup>`158.46 kB` |       <sup>*73x* </sup>`4,042 ms` |
| 4. [oxc-minify](packages/minifiers/minifiers/oxc-minify.ts)                                                                           |       <sup>-66% </sup>`716.10 kB` |       <sup>-48% </sup>`162.24 kB` |           <sup>*1x* </sup>`87 ms` |
...
xychart-beta
	...
	bar [684611,321112,321556,324570,330348,331412,331563,331847,337934]
```
...
| **Minifier**                                                                                                                          |                 **Minified size** |                **Minzipped size** |                          **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                                   | **<sup>🏆-69% </sup>`994.07 kB`** | **<sup>🏆-53% </sup>`321.11 kB`** |          <sup>*5x* </sup>`629 ms` |
| 2. [terser](packages/minifiers/minifiers/terser.ts)                                                                                   |       <sup>-69% </sup>`998.45 kB` |       <sup>-53% </sup>`321.56 kB` |       <sup>*50x* </sup>`6,086 ms` |
| 3. [oxc-minify](packages/minifiers/minifiers/oxc-minify.ts)                                                                           |         <sup>-69% </sup>`1.01 MB` |       <sup>-53% </sup>`324.57 kB` |          <sup>*1x* </sup>`173 ms` |
...
xychart-beta
	...
	bar [825175,452399,457352,459930,471791,474973,478572,488279,491833]
```
...
| **Minifier**                                                                                                                          |               **Minified size** |                **Minzipped size** |                          **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                                   | **<sup>🏆-68% </sup>`2.15 MB`** | **<sup>🏆-45% </sup>`452.40 kB`** |          <sup>*5x* </sup>`808 ms` |
| 2. [terser](packages/minifiers/minifiers/terser.ts)                                                                                   |       <sup>-66% </sup>`2.24 MB` |       <sup>-45% </sup>`457.35 kB` |       <sup>*50x* </sup>`7,180 ms` |
| 3. [oxc-minify](packages/minifiers/minifiers/oxc-minify.ts)                                                                           |       <sup>-66% </sup>`2.24 MB` |       <sup>-44% </sup>`459.93 kB` |          <sup>*1x* </sup>`251 ms` |
...
xychart-beta
	...
	bar [1884998,856799,859082,875817,876535,878642,915551]
```
...
| **Minifier**                                                                                                                           |               **Minified size** |                **Minzipped size** |                          **Time** |
| 1. [oxc-minify](packages/minifiers/minifiers/oxc-minify.ts)                                                                            |       <sup>-69% </sup>`3.34 MB` | **<sup>🏆-55% </sup>`856.80 kB`** |          <sup>*2x* </sup>`552 ms` |
| 2. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                                    | **<sup>🏆-70% </sup>`3.31 MB`** |       <sup>-54% </sup>`859.08 kB` |        <sup>*6x* </sup>`1,678 ms` |
...
<!-- analysis:start -->
The competition was fierce, with minifiers racing to deliver the smallest files and the fastest times. Some champions emerged as speed demons, others focused on cutting every byte like a skilled craftsman. Let's dive into the results and crown the best!

### Best minifier
After careful analysis, **@swc/core** takes the gold medal! Consistently delivering small gzip sizes, blazing-fast speeds, and reliability, it strikes the perfect balance for the average user. For example, in the heavy-hitters like "echarts" (684.61 kB), @swc/core minified the file to 321.11 kB in just 629 ms, significantly faster than its closest rivals while maintaining superb compression across numerous rounds.

### Honorable mentions
1. **oxc-minify**: A rising star with incredible speed! For instance, it handled the bulky "typescript" package with ease, producing an 856.80 kB file in a mere 552 ms. When you want speed and near-top-tier compression (think "terser"), this is your weapon of choice.
2. **@tdewolff/minify**: The Usain Bolt of minifiers – always the fastest to cross the line. On smaller files like "moment" and "vue," it delivered highly competitive results, often in as little as 6 to 13 ms. However, its compression wasn't always the best in class, especially with larger packages.
3. **terser**: A veteran, excelling at deep, thorough compression. For the largest files like "antd" (825.18 kB), it maintained solid compression at 457.35 kB, though it took its sweet time (7,180 ms!). A solid bet for quality results if you're less worried about processing speed.
4. **uglify-js**: Legendary precision, often producing the smallest outcomes (e.g., "lodash": 24.69 kB). However, its achingly slow speed doomed it (e.g., 6,579 ms for "victory"). If time isn't a factor, this could be your champion for bite-sized files.

### Eliminated
- **babel-minify**: Cracked under pressure with the "d3" package, throwing errors like a nervous rookie. Unreliable for production use. Avoid!
- **tedivm/jshrink**: Couldn't handle advanced patterns, buckling on "d3" with unclosed regex errors. Safe to say it's a no-go for complex projects.
- **bun**: It stumbled at the finish line during "typescript" due to newline formatting mismatches. Impressive attempt but not quite ready for prime time.
- **google-closure-compiler**: While groundbreaking in its day, frequent timeouts in larger datasets like "victory" and "antd" rendered it unfit for modern high-performance needs.

From featherweights like "react" to behemoths like "typescript," every participant brought their A-game. Kudos to all competitors for pushing the limits! If you're hunting for all-round greatness, **@swc/core** is your go-to. Need speed? **@tdewolff/minify** or **oxc-minify** might scratch that itch. For compression connoisseurs, **uglify-js** and **terser** have your back.

Let’s call it a wrap – faster, smaller, stronger web apps await with the champions above!
<!-- analysis:end -->

...
- [bun](https://github.com/oven-sh/bun) <sub>v1.2.1</sub>
...
- [@swc/core](https://github.com/swc-project/swc) <sub>v1.10.11</sub>
...
_Benchmarks last updated on <!-- lastUpdated:start -->Jan 28, 2025<!-- lastUpdated:end -->._
...
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                               |       <sup>-68% </sup>`22.86 kB` | **<sup>🏆-58% </sup>`8.17 kB`** |       <sup>*7x* </sup>`22 ms` |
...
| 2. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                   |       <sup>-67% </sup>`58.21 kB` |       <sup>-48% </sup>`18.69 kB` |      <sup>*9x* </sup>`54 ms` |
...
xychart-beta
	...
	bar [89668,42487,42919,43036,43925,44230,44368,44376,44450,44679,45400,57169]
```
...
| **Minifier**                                                                                                   |                 **Minified size** |               **Minzipped size** |                     **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                            |       <sup>-66% </sup>`115.48 kB` | **<sup>🏆-53% </sup>`42.49 kB`** |    <sup>*10x* </sup>`134 ms` |
...
| 3. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                      |       <sup>-87% </sup>`69.83 kB` |       <sup>-74% </sup>`25.16 kB` |     <sup>*9x* </sup>`117 ms` |
...
| 10. [bun](packages/minifiers/minifiers/bun.ts)                                                                           |       <sup>-87% </sup>`73.45 kB` |       <sup>-72% </sup>`26.66 kB` |      <sup>*1x* </sup>`24 ms` |
...
| 2. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                        |       <sup>-52% </sup>`265.25 kB` |       <sup>-33% </sup>`87.18 kB` |     <sup>*9x* </sup>`299 ms` |
...
| **Minifier**                                                                                                                   |                 **Minified size** |                **Minzipped size** |                     **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                            |       <sup>-55% </sup>`455.55 kB` | **<sup>🏆-36% </sup>`123.07 kB`** |     <sup>*7x* </sup>`245 ms` |
...
| **Minifier**                                                                                                               |                 **Minified size** |                **Minzipped size** |                          **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                        |       <sup>-48% </sup>`642.89 kB` | **<sup>🏆-36% </sup>`158.22 kB`** |          <sup>*7x* </sup>`384 ms` |
...
| 9. [bun](packages/minifiers/minifiers/bun.ts)                                                                              |       <sup>-47% </sup>`655.93 kB` |       <sup>-33% </sup>`166.21 kB` |           <sup>*1x* </sup>`59 ms` |
...
| 2. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                                  |       <sup>-67% </sup>`707.20 kB` |       <sup>-49% </sup>`157.79 kB` |         <sup>*10x* </sup>`610 ms` |
...
xychart-beta
	...
	bar [684611,320154,321987,330736,331412,331563,331791,337934]
```
...
| **Minifier**                                                                                                                         |                 **Minified size** |                **Minzipped size** |                          **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                                  | **<sup>🏆-69% </sup>`993.00 kB`** | **<sup>🏆-53% </sup>`320.15 kB`** |        <sup>*9x* </sup>`1,114 ms` |
...
| 7. [bun](packages/minifiers/minifiers/bun.ts)                                                                                        |         <sup>-68% </sup>`1.02 MB` |       <sup>-51% </sup>`337.93 kB` |          <sup>*1x* </sup>`136 ms` |
...
| **Minifier**                                                                                                                         |               **Minified size** |                **Minzipped size** |                          **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                                  | **<sup>🏆-68% </sup>`2.15 MB`** | **<sup>🏆-45% </sup>`453.13 kB`** |       <sup>*10x* </sup>`1,452 ms` |
...
| 7. [bun](packages/minifiers/minifiers/bun.ts)                                                                                        |       <sup>-66% </sup>`2.30 MB` |       <sup>-40% </sup>`491.83 kB` |          <sup>*1x* </sup>`186 ms` |
| 8. [babel-minify](packages/minifiers/minifiers/babel-minify.ts) <sub title="Failed: timeout">❌ Timed out</sub>                       |                               - |                                 - | <sup>:warning:</sup> `+10,000 ms` |
| 9. [google-closure-compiler](packages/minifiers/minifiers/google-closure-compiler.ts) <sub title="Failed: timeout">❌ Timed out</sub> |                               - |                                 - | <sup>:warning:</sup> `+10,000 ms` |
...
xychart-beta
	...
	bar [1884998,851755,876535,876658,879301,915495]
```
...
| **Minifier**                                                                                                                           |               **Minified size** |                **Minzipped size** |                          **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                                    | **<sup>🏆-70% </sup>`3.31 MB`** | **<sup>🏆-55% </sup>`851.76 kB`** |       <sup>*11x* </sup>`2,936 ms` |

...
| ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ | -------------- |
| [google-closure-compiler](https://github.com/git+https://github.com/google/closure-compiler-npm.git#master) | [20250603.0.0](https://www.npmjs.com/package/google-closure-compiler/v/20250603.0.0) | 2025-06-05     |
| [@swc/core](https://github.com/swc-project/swc)                                                             | [1.11.31](https://www.npmjs.com/package/@swc/core/v/1.11.31)                         | 2025-06-05     |
| [oxc-minify](https://github.com/oxc-project/oxc.git)                                                        | [0.72.2](https://www.npmjs.com/package/oxc-minify/v/0.72.2)                          | 2025-05-31     |
| [bun](https://github.com/oven-sh/bun)                                                                       | [1.2.15](https://www.npmjs.com/package/bun/v/1.2.15)                                 | 2025-05-28     |
...
_Benchmarks last updated on <!-- lastUpdated:start -->Jun 5, 2025<!-- lastUpdated:end -->._
...
| 3. [google-closure-compiler](packages/minifiers/minifiers/google-closure-compiler.ts)                                             |       <sup>-68% </sup>`22.84 kB` |       <sup>-58% </sup>`8.22 kB` | <sup>*1460x* </sup>`3,835 ms` |
...
| 3. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                   |       <sup>-66% </sup>`58.43 kB` |       <sup>-48% </sup>`18.75 kB` |      <sup>*5x* </sup>`33 ms` |
| 4. [google-closure-compiler](packages/minifiers/minifiers/google-closure-compiler.ts)                                 |       <sup>-66% </sup>`58.29 kB` |       <sup>-48% </sup>`18.92 kB` | <sup>*653x* </sup>`3,642 ms` |
...
| 11. [google-closure-compiler](packages/minifiers/minifiers/google-closure-compiler.ts)                                  |       <sup>-68% </sup>`92.73 kB` |       <sup>-61% </sup>`33.09 kB` | <sup>*510x* </sup>`4,017 ms` |
...
| **Minifier**                                                                                                   |                 **Minified size** |               **Minzipped size** |                     **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                            |       <sup>-66% </sup>`115.70 kB` | **<sup>🏆-52% </sup>`42.73 kB`** |      <sup>*5x* </sup>`71 ms` |
...
| 6. [google-closure-compiler](packages/minifiers/minifiers/google-closure-compiler.ts)                          |       <sup>-66% </sup>`115.61 kB` |       <sup>-51% </sup>`44.18 kB` | <sup>*336x* </sup>`4,400 ms` |
...
| 2. [google-closure-compiler](packages/minifiers/minifiers/google-closure-compiler.ts)                                    |       <sup>-86% </sup>`73.50 kB` |       <sup>-74% </sup>`25.02 kB` | <sup>*353x* </sup>`4,151 ms` |
| 3. [terser](packages/minifiers/minifiers/terser.ts)                                                                      |       <sup>-87% </sup>`70.67 kB` |       <sup>-74% </sup>`25.19 kB` |  <sup>*86x* </sup>`1,021 ms` |
| 4. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                      |       <sup>-87% </sup>`69.82 kB` |       <sup>-74% </sup>`25.24 kB` |      <sup>*4x* </sup>`58 ms` |
...
| 2. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                        |       <sup>-52% </sup>`265.22 kB` |       <sup>-33% </sup>`87.21 kB` |     <sup>*4x* </sup>`155 ms` |
...
| 10. [google-closure-compiler](packages/minifiers/minifiers/google-closure-compiler.ts)                                     |       <sup>-51% </sup>`270.32 kB` |       <sup>-28% </sup>`94.17 kB` | <sup>*204x* </sup>`6,608 ms` |
...
| 2. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                            |       <sup>-55% </sup>`455.63 kB` |       <sup>-36% </sup>`123.29 kB` |     <sup>*4x* </sup>`143 ms` |
...
| 8. [google-closure-compiler](packages/minifiers/minifiers/google-closure-compiler.ts)                                          | **<sup>🏆-56% </sup>`439.97 kB`** |       <sup>-35% </sup>`126.45 kB` | <sup>*173x* </sup>`6,032 ms` |
...
| 5. [google-closure-compiler](packages/minifiers/minifiers/google-closure-compiler.ts)                                      |       <sup>-48% </sup>`644.52 kB` |       <sup>-34% </sup>`162.77 kB` |      <sup>*153x* </sup>`7,653 ms` |
...
| 2. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                                   |       <sup>-67% </sup>`706.21 kB` |       <sup>-49% </sup>`157.84 kB` |          <sup>*5x* </sup>`319 ms` |
| 3. [terser](packages/minifiers/minifiers/terser.ts)                                                                                   |       <sup>-66% </sup>`715.59 kB` |       <sup>-49% </sup>`158.71 kB` |       <sup>*77x* </sup>`4,225 ms` |
| 4. [oxc-minify](packages/minifiers/minifiers/oxc-minify.ts)                                                                           |       <sup>-66% </sup>`716.13 kB` |       <sup>-48% </sup>`162.25 kB` |           <sup>*1x* </sup>`80 ms` |
...
| 9. [bun](packages/minifiers/minifiers/bun.ts)                                                                                         |       <sup>-66% </sup>`727.90 kB` |       <sup>-41% </sup>`182.67 kB` |           <sup>*1x* </sup>`78 ms` |
...
| **Minifier**                                                                                                                          |                 **Minified size** |                **Minzipped size** |                          **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                                   | **<sup>🏆-69% </sup>`994.54 kB`** | **<sup>🏆-53% </sup>`321.26 kB`** |          <sup>*4x* </sup>`596 ms` |
| 2. [terser](packages/minifiers/minifiers/terser.ts)                                                                                   |         <sup>-69% </sup>`1.00 MB` |       <sup>-53% </sup>`321.99 kB` |       <sup>*52x* </sup>`6,346 ms` |
| 3. [oxc-minify](packages/minifiers/minifiers/oxc-minify.ts)                                                                           |         <sup>-69% </sup>`1.01 MB` |       <sup>-53% </sup>`324.61 kB` |          <sup>*1x* </sup>`156 ms` |
...
| 8. [bun](packages/minifiers/minifiers/bun.ts)                                                                                         |         <sup>-68% </sup>`1.02 MB` |       <sup>-51% </sup>`337.93 kB` |          <sup>*1x* </sup>`123 ms` |
...
| **Minifier**                                                                                                                          |               **Minified size** |                **Minzipped size** |                          **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                                   | **<sup>🏆-68% </sup>`2.15 MB`** | **<sup>🏆-45% </sup>`452.48 kB`** |          <sup>*6x* </sup>`851 ms` |
| 2. [terser](packages/minifiers/minifiers/terser.ts)                                                                                   |       <sup>-66% </sup>`2.25 MB` |       <sup>-45% </sup>`457.79 kB` |       <sup>*49x* </sup>`7,047 ms` |
| 3. [oxc-minify](packages/minifiers/minifiers/oxc-minify.ts)                                                                           |       <sup>-66% </sup>`2.28 MB` |       <sup>-44% </sup>`463.33 kB` |          <sup>*1x* </sup>`196 ms` |
...
| 8. [bun](packages/minifiers/minifiers/bun.ts)                                                                                         |       <sup>-66% </sup>`2.30 MB` |       <sup>-40% </sup>`491.83 kB` |          <sup>*1x* </sup>`170 ms` |
| 9. [babel-minify](packages/minifiers/minifiers/babel-minify.ts) <sub title="Failed: timeout">❌ Timed out</sub>                        |                               - |                                 - | <sup>:warning:</sup> `+10,000 ms` |
...
| **Minifier**                                                                                                                           |               **Minified size** |                **Minzipped size** |                          **Time** |
| 1. [@swc/core](packages/minifiers/minifiers/swc.ts)                                                                                    | **<sup>🏆-70% </sup>`3.31 MB`** | **<sup>🏆-54% </sup>`859.20 kB`** |        <sup>*6x* </sup>`1,703 ms` |
| 2. [oxc-minify](packages/minifiers/minifiers/oxc-minify.ts)                                                                            |       <sup>-69% </sup>`3.35 MB` |       <sup>-54% </sup>`860.66 kB` |          <sup>*1x* </sup>`396 ms` |
...
<!-- analysis:start -->
The minification world has been shaken to its core! Minifiers battled ferociously to prove their prowess, slicing and dicing bytes with precision. Who emerged victorious, and who fell? Let’s dive straight into the excitement!

### Best minifier
**@swc/core** takes the crown! This minifier delivered the smallest Gzip output across numerous rounds while maintaining jaw-dropping speed. For instance:
- Minified "three" down to 158.76 kB in just **226 ms** (compression rate: 64%, fastest of all competitors here!).
- Crushed "antd" to 452.48 kB in **851 ms**, maintaining an excellent 55% compression.

That consistent performance in keeping Gzip sizes tight while speeding through hefty bundles makes @swc/core a perfect balance of efficiency and speed. If you want a top-dog minifier, **this is your champion**!

### Honorable mentions
**1. oxc-minify**  
This one is blistering fast, often clocking in as the fastest minifier of the batch. Performance examples:
- "lodash" was processed in a shocking **12 ms**, resulting in a tidy 25.98 kB (27% compression)!
- "typescript" took only **396 ms** to shrink down to 860.66 kB with a competitive 46% compression.  
While its Gzip size is marginally larger than @swc/core, its unrelenting speed makes it shine for those who prioritize minimization speed over squeezing every byte.

**2. uglify-js**  
Still the Gzip master when runtime isn’t a concern! It consistently delivered the **smallest Gzip** sizes:
- "react" hit a mere 8.18 kB (42%) in exchange for a more leisurely **497 ms** processing time.
- "lodash" dropped to an impressive 24.69 kB (26%) — the best among all — at the cost of **1.6 seconds.**  
So, if absolute file size savings matter more than speed, uglify-js might be your best companion.

**3. @tdewolff/minify**  
The indisputable sprint champion! It continuously outpaced the competition with record-breaking speed:
- Processed "d3" in an unbelievable **32 ms**, albeit at a loosening compression of 69%.
- Turned "antd" into 471.79 kB in **141 ms**, making it ideal for quick-turnaround scenarios.  
Its sizes didn’t contest the smallest, but the insane speed makes it a top pick where milliseconds matter more than bytes.

### Eliminated
The elimination stage had audiences gasping!  
- **babel-minify** stumbled during "d3" with a fatal "cannot read properties of undefined" error.  
- **tedivm/jshrink** couldn’t hold its regex parsing together and self-destructed on "d3."  
- **bun** disqualified itself with trailing carriage-return mismatches on "typescript."  
While these minifiers have their use cases, they’re simply too risky for serious projects that demand robustness.

The competition was fierce, the results riveting, and the minifiers awe-inspiring. Congratulations to all participants for living up to the challenge! For your average user? You can’t go wrong with @swc/core, oxc-minify, or uglify-js, depending on your needs. Minify on, my friends; the byte-busting journey never stops!
<!-- analysis:end -->
